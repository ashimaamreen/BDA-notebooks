with joinNgo as (
SELECT distinct membernumber,contact_id,prod_name,item_promo_name, nrp_prod_name, renewed_prod_name, x_renewal_status, asset_end_dt
from `mynrma-mm-ds-dw-sandbox-a815.datasci.subs_base`
where item_promo_name like 'Add%'
and prod_name not like '%Free2go%'
and date(asset_end_dt) between '2021-12-31' and '2022-01-07'
--AND membernumber in ('122008402','155099501','157628401','67234701','168413501','169968301')
)
    select a.*
            -- ,conx.attrib_36 
            -- ,fn.brloc_attrib13
